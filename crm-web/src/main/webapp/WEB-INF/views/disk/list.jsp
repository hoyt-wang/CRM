                ...
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <c:if test="${not empty disk}">
                            <a href="/disk/list?_=${disk.pId}" class="btn btn-default btn-sm"><i class="fa fa-arrow-left"></i> 返回上级</a>
                        </c:if>
                        <c:choose>
                            <c:when test="${disk.type == 'file'}">
                                <a href="/disk/download?_=${disk.id}" class="btn btn-sm btn-info"><i class="fa fa-download"></i> 下载</a>
                            </c:when>
                            <c:otherwise>
                                <div  id="picker"><i class="fa fa-upload"></i> 上传文件</div>
                                <button class="btn btn-success btn-sm" id="showNewFolderModal"><i class="fa fa-plus"></i> 新建文件夹</button>
                            </c:otherwise>
                        </c:choose>
                    </div>
                </div>
...
<script>
    $(function(){
        ...
        $(document).delegate(".tr","click",function () {
            ...
            window.location.href = "/disk/list?_="+id;
        });
