...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview ${fn:startsWith(param.menu, 'record_') ? 'active' : ''}">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="${param.menu == 'record_public' ? 'active' : ''}"><a href="/record/public"><i class="fa fa-circle-o"></i> 公共记录</a></li>
                </ul>
            </li>
            <!-- 待办事项 -->
            <li class="treeview ${fn:startsWith(param.menu, 'task_') ? 'active' : ''}">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="${param.menu == 'task_delay' ? 'active' : ''}"><a href="/task/delay"><i class="fa fa-circle-o"></i> 逾期事项</a></li>
                </ul>
            </li>
            <!-- 统计报表 -->
            ...
            <li class="${param.menu == 'disk' ? 'active' : ''}"><a href="/disk/list"><i class="fa fa-share-alt"></i> <span>公司网盘</span></a></li>
